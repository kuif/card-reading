...
# @Last Modified time: 2020-05-13 09:20:41
...
class cardReading(object):
    ...
    def reading(self, url, count):
        ...
        yt1=[3450,3620,3740,3865,3975,4140,4300,4400,4530,4645,4800,4960,5080,5200,5310,5440]
        student = '' # 学号
        IDAnswer = [] # 对应题号及答案
        ...
        ChQImg = cv2.threshold(ChQImg, 60, 225, cv2.THRESH_BINARY)[1]
        ...
        for c in cnts:
        	...
        	if ((y>3500 and y<5440) or (y>2110 and y<3140)) and x > 400 and w > 80 and h > 20:
        	    M = cv2.moments(c)
        	    cX = int(M["m10"] / M["m00"])
        	    cY = int(M["m01"] / M["m00"])
        	    #绘制中心及其轮廓
        ...
        next_link = "D:/Python/www/duka/%02d.jpg" % count;
        cv2.imwrite(next_link,fImage)
...
if __name__=="__main__":
    url = ['D:/Python/www/duka/image/demo.jpg', 'D:/Python/www/duka/image/1.jpg', 'D:/Python/www/duka/image/2.jpg', 'D:/Python/www/duka/image/3.jpg']
