...
#数字识别
"""
template0=cv2.imread('D:/Python/www/duka/source/img0/1.jpg',0)
template1=cv2.imread('D:/Python/www/duka/source/img1/0.jpg',0)
template2=cv2.imread('D:/Python/www/duka/source/img2/0.jpg',0)
template3=cv2.imread('D:/Python/www/duka/source/img3/0.jpg',0)
template4=cv2.imread('D:/Python/www/duka/source/img4/0.jpg',0)
template5=cv2.imread('D:/Python/www/duka/source/img5/0.jpg',0)
template6=cv2.imread('D:/Python/www/duka/source/img6/0.jpg',0)
template7=cv2.imread('D:/Python/www/duka/source/img7/0.jpg',0)
template8=cv2.imread('D:/Python/www/duka/source/img8/0.jpg',0)
template9=cv2.imread('D:/Python/www/duka/source/img9/0.jpg',0)
#templatex=cv2.imread('D:/Python/www/duka/source/imgx/0.jpg',0)
...
'''
'''
testimage=Image.open('D:/Python/www/duka/source/test.png')
...
def congnitive(name):
    ...
    data['imagetype'] = "1"
    # 图片在本地
    file_object = open('D:/Python/www/duka/source/storetmp/'+ name+'.png', 'rb')
    try:
    ...
    if (content):
        ...
        with open('D:/Python/www/duka/source/storetmp/'+ name + '.json', 'w') as json_file:
            json_file.write(json.dumps(content))
            get(json_file)
        print(content)
def cutpic(img):
    tempimg1=img[240:461,213:939]
    tempimg1 = cv2.resize(tempimg1, (500, 100), cv2.INTER_LANCZOS4)
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T.png", tempimg1)
    tempimg2 = img[476:725, 221:1258]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/TTTT.png", tempimg2)
    tempimg3 = img[476:725, 1258:2293]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/TTTT2.png", tempimg3)
    tempimg4 = img[2236:2691, 100:379]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T1.png", tempimg4)
    tempimg5 = img[2236:2691, 597:864]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T2.png", tempimg5)
    tempimg6 = img[2236:2691, 1063:1337]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T3.png", tempimg6)
    tempimg7 = img[2236:2691, 1533:1808]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T4.png", tempimg7)
    tempimg8 = img[2236:2691, 2003:2281]
    cv2.imwrite("D:/Python/www/duka/source/storetmp/T5.png", tempimg8)

def read(name):
    with open('D:/Python/www/duka/source/storetmp/'+name+'.json',encoding='utf-8') as json_file:
...
                •cv2.THRESH_TOZERO_INV    
    ...
    # cv2.imwrite("D:/Python/www/duka/source/temp.jpg",NumImg)
